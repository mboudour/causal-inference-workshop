...
dir.create("day1/data/dags", showWarnings = FALSE, recursive = TRUE)
...
# ---------------------------------------------------------------------------
# Colour palette (matches Python script exactly)
# ---------------------------------------------------------------------------
...
render_dot(dag1, "day1/data/dags/dag1_baseline.png")
...
render_dot(dag2, "day1/data/dags/dag2_adjustment.png")
...
render_dot(dag3, "day1/data/dags/dag3_measurement.png")
