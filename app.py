...
| [Day 1 NZ HoR](Day_1_NZ) | New Zealand adaptation of Day 1 using ParlSpeech V2 speeches | ✅ Available |
...
| [Day 2 NZ HoR](Day_2_NZ) | New Zealand adaptation of Day 2 using ParlSpeech V2 speeches | ✅ Available |
| [Day 3 Hein Bound 111](Day_3) | Estimation & Auditing with LLMs: DML, DSL, Causal Auditing | ✅ Available |
| [Day 3 NZ HoR](Day_3_NZ) | New Zealand adaptation of Day 3 using ParlSpeech V2 speeches | ✅ Available |
"""
)
